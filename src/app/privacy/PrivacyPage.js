  ...
  return (
    <>
      <style>{`
        ...
        /* ─── Apply Comfortaa to EVERYTHING ─── */
        * {
          font-family: 'Comfortaa', cursive !important;
        }

        /* ─── Also explicitly apply to body and all elements ─── */
        body, html, div, span, h1, h2, h3, h4, h5, h6, p, a, button, input, textarea, select, li, ul, ol, section, article, header, footer, nav, main, aside, figure, figcaption, blockquote, pre, code, small, strong, em, b, i, u, s, strike, mark, del, ins, sub, sup, dd, dl, dt, table, th, td, tr, thead, tbody, tfoot, caption, form, fieldset, legend, label, option, optgroup, iframe, canvas, svg, path, rect, circle, polygon, text, tspan {
          font-family: 'Comfortaa', cursive !important;
        }

        /* ─── Ensure all elements inside .prv-root get Comfortaa ─── */
        .prv-root,
        .prv-root *,
        .prv-root *::before,
        .prv-root *::after {
        ...
        .quick-card h3 { font-size: 13px;font-weight: 700;color: #1a2e44;line-height: 1.4; }
        ...
        .col-num { font-weight: 800;font-size: 70px;color: rgba(26,46,68,0.05);line-height: 0.9;margin-bottom: -8px; }
        .col-title { font-size: clamp(24px, 4vw, 40px);font-weight: 800;color: #1a2e44;line-height: 1.15;margin-bottom: 14px; }
...
.footer-col-title { font-size: 10px; font-weight: 900; text-transform: uppercase; letter-spacing: 2px; color: #64748B; margin: 0 0 10px 0; }
.footer-col-links { display: flex; justify-content: center; align-items: center; gap: 24px; flex-wrap: wrap; }
.footer-link { display: inline-block; font-size: 13px; font-weight: 700; color: #475569; text-decoration: none; cursor: pointer; transition: color .2s ease; position: relative; }
...
.footer-copyright { font-size: 12px; font-weight: 700; color: #64748B; letter-spacing: .3px; transition: color .2s ease; }
