...
function SocialComingSoonModal({ platform, onClose }) {
      ...
      <style>{`
        ...
        *, *::before, *::after { margin: 0; padding: 0; box-sizing: border-box; }
        ...
        .nav-btn {
          ...
          font-family: var(--font-comfortaa), sans-serif;;font-size: 13px;font-weight: 600;
        ...
        .hero-title { font-family: var(--font-comfortaa), sans-serif;;font-size: clamp(32px, 6vw, 72px);font-weight: 800;color: #1a2e44;line-height: 1.1;margin-bottom: 40px; }
        .hero-btn {
          display: inline-flex;align-items: center;gap: 10px;
          padding: 12px 28px;background: #1a2e44;color: #fff;
          font-family: var(--font-comfortaa), sans-serif;;font-size: 15px;font-weight: 600;
        ...
        .quick-card h3 { font-family: var(--font-comfortaa), sans-serif;;font-size: 13px;font-weight: 700;color: #1a2e44;line-height: 1.4; }
        ...
        .col-num { font-family: var(--font-comfortaa), sans-serif;;font-weight: 800;font-size: 70px;color: rgba(26,46,68,0.05);line-height: 0.9;margin-bottom: -8px; }
        .col-title { font-family: var(--font-comfortaa), sans-serif;;font-size: clamp(24px, 4vw, 40px);font-weight: 800;color: #1a2e44;line-height: 1.15;margin-bottom: 14px; }
        .col-desc { font-size: 14px;color: rgba(26,46,68,0.6);line-height: 1.7;margin-bottom: 24px; }
        .back-top-btn { display: inline-flex;align-items: center;gap: 8px;padding: 9px 24px;background: transparent;border: 1.5px solid rgba(26,46,68,0.15);border-radius: 100px;font-family: var(--font-comfortaa), sans-serif;;font-size: 13px;font-weight: 600;color: #1a2e44;cursor: pointer;transition: all 0.25s ease; }
        ...
        .acc-q span { font-family: var(--font-comfortaa), sans-serif;;font-size: clamp(13px, 4vw, 15px);font-weight: 600;color: #1a2e44;line-height: 1.4; }
        ...
        .footer-col-title { font-family: var(--font-comfortaa), sans-serif;;font-size: 10px;font-weight: 700;text-transform: uppercase;letter-spacing: 2px;color: #64748B;margin: 0 0 10px 0; }
        .footer-col-links { display: flex;justify-content: center;align-items: center;gap: 24px;flex-wrap: wrap; }
        .footer-link {
          display: inline-block;font-family: var(--font-comfortaa), sans-serif;;font-size: 13px;font-weight: 600;color: #475569;text-decoration: none;cursor: pointer;transition: color .2s ease;
        }
        ...
        .footer-copyright { font-family: var(--font-comfortaa), sans-serif;;font-size: 12px;font-weight: 600;color: #64748B;letter-spacing: .3px;transition: color .2s ease; }
