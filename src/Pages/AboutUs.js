...
.section {
  ...
  /* Extra bottom padding so fixed footer never hides content */
  padding-top: 80px;
  padding-bottom: 64px;
}
...
/* ─── DEFAULT: all animated children hidden ─── */
.hero-content > *,
.form-left > *,
.form-right,
.connect-content > *,
...
/* ─── VISIBLE: animate into place (only plays once thanks to 'seen' state) ─── */
...
.seen .connect-card        { animation: scaleIn   0.42s ease forwards; }
.seen .connect-card:nth-child(1) { animation-delay: 0.04s; }
.seen .connect-card:nth-child(2) { animation-delay: 0.10s; }
.seen .connect-card:nth-child(3) { animation-delay: 0.16s; }
.seen .connect-card:nth-child(4) { animation-delay: 0.22s; }
.seen .connect-card:nth-child(5) { animation-delay: 0.28s; }
.seen .connect-card:nth-child(6) { animation-delay: 0.34s; }
...
.seen .faq-item            { animation: fadeRight 0.44s ease forwards; }
.seen .faq-item:nth-child(1) { animation-delay: 0.02s; }
.seen .faq-item:nth-child(2) { animation-delay: 0.08s; }
.seen .faq-item:nth-child(3) { animation-delay: 0.14s; }
.seen .faq-item:nth-child(4) { animation-delay: 0.20s; }
.seen .faq-item:nth-child(5) { animation-delay: 0.26s; }
...
.logo {
  ...
  background: linear-gradient(135deg,#1a2e44,#2c4a6e);
...
.connect-card:hover { transform: translateY(-4px); background: rgba(255,255,255,0.85); box-shadow: 0 12px 24px rgba(0,0,0,0.07); }
.c-ico {
  width: 46px;
  height: 46px;
  border-radius: 14px;
...
.c-name   { font-size: 14px; font-weight: 700; color: var(--navy); margin-bottom: 2px; white-space: nowrap; overflow: hidden; text-overflow: ellipsis; }
.c-handle { font-size: 11px; color: var(--navy40); margin-bottom: 5px; white-space: nowrap; overflow: hidden; text-overflow: ellipsis; }
.c-pill   { display: inline-block; padding: 2px 8px; border-radius: var(--radius-pill); font-size: 10px; font-weight: 700; }
...
@media (max-width: 640px) {
  ...
  .connect-card { border-radius: 16px; }
...
<div className="logo">
  <img src="/sharxbg.png" alt="SHARX Logo" />
        ...
        ══════════════════════════ */}
        <div
          className={`section s1 ${seenSections.has(0) ? "seen" : ""}`}
          ref={sectionRefs[0]}
        >
          <div className="blobs">
            <div className="blob" />
        ...
        ══════════════════════════ */}
        <div
          className={`section s2 ${seenSections.has(1) ? "seen" : ""}`}
          ref={sectionRefs[1]}
        >
          <div className="blobs">
            <div className="blob" />
        ...
        ══════════════════════════ */}
        <div
          className={`section s3 ${seenSections.has(2) ? "seen" : ""}`}
          ref={sectionRefs[2]}
        >
          <div className="blobs">
            <div className="blob" />
                ...
                {connects.map(c => (
                  <div key={c.name} className="connect-card">
                    ...
                    <div className="c-info">
                      ...
                      <div className="c-pill" style={{ background: c.bg, color: c.accent }}>{c.pill}</div>
                    </div>
                  </div>
                ))}
              </div> */}
        ...
        <div
          className={`section s4 ${seenSections.has(3) ? "seen" : ""}`}
          ref={sectionRefs[3]}
        >
          <div className="blobs">
            <div className="blob" />
