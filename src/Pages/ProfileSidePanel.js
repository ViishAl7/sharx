  ...
  return (
    <div className="psp-editor" style={{ "--psp-grad": grad, "--psp-blob-color": cfg.blob }}>
      ...
      <div className="psp-editTop">
        <button className="psp-edAction x"  onClick={onCancel}  aria-label="Cancel"><I.X /></button>
        <button className="psp-edAction ok" onClick={() => onSave({ shape: s, eyes: e, color: c, name: n })} aria-label="Save"><I.Check /></button>
